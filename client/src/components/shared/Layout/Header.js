    ...
    <>
        <nav className='navbar'>
            <div className="container-fluid">
                <div className="navbar-brand h1 redline-logo">
  <MdOutlineBloodtype color='red' className="blood-icon" />
  <span className="red">BLOOD</span><span className="line">BRIDGE</span>
</div>
